...
This repository
Search
Watch 12  Star 173  Fork 63 ngokevin/kframe
Code  Issues 7  Pull requests 0  Projects 0  Pulse  Graphs
Browse files
[sun-sky] publish sun-sky
master
1 parent 10df598 commit c6a801e9355f39d753f73a8e50402f662dc0ad5d @ngokevin ngokevin committed on 20 Sep 2016
Unified Split
Showing  4 changed files  with 105 additions and 31 deletions.
View
101  components/sun-sky/dist/aframe-sun-sky.js
@@ -0,0 +1,101 @@
...
+/******/ ]);
View
1  components/sun-sky/dist/aframe-sun-sky.min.js
Diff suppressed. Click to show.
View
3  components/sun-sky/package.json
@@ -1,9 +1,10 @@
{
    "name": "aframe-sun-sky",
 -  "version": "3.0.0",
 +  "version": "3.0.1",
    ...
    "main": "index.js",
    "scripts": {
        +    "dist": "webpack --module-bind 'glsl=shader' index.js dist/aframe-sun-sky.js && webpack --module-bind 'glsl=shader' -p index.js dist/aframe-sun-sky.min.js",
             "postpublish": "npm run dist"
    },
  "repository": {
      View
      31  webpack-dev.config.js
      Diff suppressed. Click to show.
      0 comments on commit c6a801e
